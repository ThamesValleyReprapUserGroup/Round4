...
module x_end_motor_base(){
 mirror([0,1,0])translate([0,18.2,0])x_end_base();
...
module x_end_motor_holes(){
 mirror([0,1,0])translate([0,18.2,0])x_end_holes();
 // Position to place
...
bearing_size = bearing_diameter + 2 * thinwall;
        ...
        translate(v=[0,-18.2,10]) poly_cylinder(h = 62, r=(bearing_diameter/2)+0.1);
         
 }
 
}

translate([0,-2.8,0])x_end_motor();